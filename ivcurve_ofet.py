...
filename = 'ivcurve.txt' # name of file
sd_max_voltage = 40 
set_gate_voltage = 0
averages = 10
...
sd_min_voltage = -sd_max_voltage
data_points = abs(2*sd_max_voltage+1)
...
voltages = np.linspace(sd_min_voltage, sd_max_voltage, num=data_points)
